            ...
            <form onSubmit={submitHandler}>
              <div className="mb-5">
                <input
                  ...
                  className="w-full pr-4 py-3 border-b border-solid border-[#00066ff61] focus:outline-none focus:border-b-primaryColor text-[14px] leading-7 text-headingColor placeholder:text-textColor rounded-md cursor-pointer"
                  required
                />
              </div>
              <div className="mb-5">
